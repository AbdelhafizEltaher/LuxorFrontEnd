export enum HttpPaths {
    API_USER_LOGIN='https://localhost:7168/api/Auth/login',
    API_USER_REGISTER='https://localhost:7168/api/Auth/register',
    API_USER_LOGOUT='https://localhost:7168/api/Auth/logOut',
